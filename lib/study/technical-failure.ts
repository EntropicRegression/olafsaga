...
const FAILURE_CATALOG: Record<TechnicalFailureCode, TechnicalFailure> = {
  ...
  SEMANTIC_AUTH_FAILED: {
    ...
    stage: "semantic",
    label: "語意分析憑證錯誤",
    userMessage: "Azure OpenAI 憑證驗證失敗。錄音已保留，請通知研究人員檢查 Key 後再錄一次。",
    retryable: true,
  },
  SEMANTIC_DEPLOYMENT_NOT_FOUND: {
  ...
  SEMANTIC_RATE_LIMITED: {
    ...
    stage: "semantic",
    label: "語意分析流量超限",
    userMessage: "語意分析服務目前忙碌。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  SEMANTIC_TIMEOUT: {
    ...
    stage: "semantic",
    label: "語意分析逾時",
    userMessage: "語意分析等候逾時。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  SEMANTIC_INVALID_RESPONSE: {
    ...
    stage: "semantic",
    label: "語意分析回應格式錯誤",
    userMessage: "語意分析服務回傳了無法讀取的結果。錄音已保留，請再錄一次。",
    retryable: true,
  },
  SEMANTIC_SERVICE_UNAVAILABLE: {
    ...
    stage: "semantic",
    label: "語意分析服務異常",
    userMessage: "語意分析服務暫時無法使用。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  EMOTION_NOT_CONFIGURED: {
  ...
  EMOTION_RATE_LIMITED: {
    ...
    stage: "emotion",
    label: "情緒分析流量超限",
    userMessage: "情緒分析服務目前忙碌。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  EMOTION_TIMEOUT: {
    ...
    stage: "emotion",
    label: "情緒分析逾時",
    userMessage: "情緒分析等候逾時。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  EMOTION_INVALID_RESPONSE: {
    ...
    stage: "emotion",
    label: "情緒分析回應格式錯誤",
    userMessage: "情緒分析服務回傳了無法讀取的結果。錄音已保留，請再錄一次。",
    retryable: true,
  },
  EMOTION_SERVICE_UNAVAILABLE: {
    ...
    stage: "emotion",
    label: "情緒分析服務異常",
    userMessage: "情緒分析服務暫時無法使用。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
  NETWORK_ERROR: {
    code: "NETWORK_ERROR",
  ...
  ANALYSIS_FAILED: {
    ...
    stage: "analysis",
    label: "系統分析錯誤",
    userMessage: "系統分析暫時失敗。錄音已保留，請稍後再錄一次。",
    retryable: true,
  },
};
